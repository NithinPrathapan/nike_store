...
const Hero = () => {
  return (
    <section
      id="home"
      className="w-full flex xl:flex-row flex-col border-2 padding-x
       border-red-500  min-h-screen max-container "
    >
      <div
      ...
      >
        ...
        <h1
          className="mt-10 w-full font-palanquin max-sm:text-[72px] text-[80px]
        ...
        >
          {statistics.map((stat) => (
            <div key={stat.label}>
              ...
              <p className="leading-7 font-palanquin">{stat.label}</p>
            </div>
          ))}
        </div>
      </div>
